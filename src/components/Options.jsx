...
export default (props) => {
    ...
    return (
        <div class={styles.optionsContainer} classList={{[styles.full]: props.showOptions() == true}}>
            <button tabIndex="-1" onKeyUp={e => e.preventDefault()} onClick={() => props.setShowOptions(!props.showOptions())} classList={{[styles.buttonFull]: props.showOptions() == true, [styles.btnOptionsButton]: true, [styles.hidden]: fadeOptions() == true}}>
