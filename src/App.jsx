          ...
          >
            <div class={styles.credits}>
              ...
              <p class={styles.disclaimer}>
                The content within this website may contain copyrighted material used under the guidelines of fair use for educational purposes only. The views and opinions expressed in this content are those of Square Enix and do not necessarily reflect the official policy or position of Square Enix. The copyrighted material has been included in this content because of its relevance and importance to the educational objectives of this project. The use of this copyrighted material is not intended to infringe upon the owner's rights nor is it intended to be claimed as our own. We ask that you please buy the game if you are using this as a learning resource, as this is intended to be used as an educational resource alongside the original Final Fantasy VII game.
              </p>
            </div>
          </Modal>
        </Show>
